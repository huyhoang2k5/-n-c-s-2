        ...
        (e.Calendar = function (t, n) {
            document.querySelectorAll(t).forEach((t) => {
                let a = t.id,
                    ...
                    l = function () {
                        document
                            .querySelectorAll(".event-popover")
                            .forEach((e) => {
                                e.remove();
                            });
                    };
                if ("undefined" != i && null != i) {
                    ...
                    t.render(),
                        ...
                        e.Event.delete(),
                        e.Event.form(),
                        e.DatePicker(".fc-event-datepicker", {
                            buttonClass: "btn",
                            autohide: !0,
                            format: "yyyy-mm-dd",
                        }),
                    ...
                    let m,
                        ...
                        S =
                            (g.querySelector(".fc-form-action"),
                            g.querySelector("#eventTitle")),
                    ...
                    f.addEventListener("click", function (e) {
                        ...
                        h.addEventListener("click", function (e) {
                            ...
                            (s = s[s.length - 2]),
                                ...
                                (M.value = m._def.extendedProps.description
                                    ? m._def.extendedProps.description
                                    : ""),
                                (E.value = n),
                                (w.value = a),
                                (D.value = l),
                                (x.value = s),
                                u.setChoiceByValue(
                                    m._def.ui.classNames[0].slice(3)
                                ),
