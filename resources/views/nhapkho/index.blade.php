                                ...
                                <ul class="d-flex">
                                    <li><a href="{{ route('nhap-kho.create') }}"
                                            class="btn btn-primary btn-md d-md-none"><em
                                                class="icon ni ni-plus"></em><span>Nhập</span></a></li>
                                    <li><a href="{{ route('nhap-kho.create') }}"
                                            class="btn btn-primary d-none d-md-inline-flex"><em
                                                class="icon ni ni-plus"></em><span>Nhập kho</span></a>
                                    </li>
                                    <li style="margin-left: 10px"><a href="#"
                                            class="btn btn-primary d-none d-md-inline-flex" data-bs-toggle="modal"
                                            data-bs-target="#nhap_excel"><em class="icon ni ni-plus"></em><span>Nhập
                                                Excel</span></a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="card">
                            <table class="datatable-init table" data-nk-container="table-responsive">
                                <thead class="table-light">
                                    <tr>
                                        <th class="tb-col"><span class="overline-title">Mã phiếu nhập</span>
                                        </th>
                                        <th class="tb-col"><span class="overline-title">Tên người nhập</span></th>
                                        <th class="tb-col"><span class="overline-title">Ngày nhập kho</span></th>
                                        <th class="tb-col tb-col-end"><span class="overline-title">Hành động</span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($phieu_nhap as $phieu)
                                        <tr>
                                            <td class="tb-col"><span>#{{ $phieu->ma_phieu_nhap }}</span></td>
                                            <td class="tb-col"><span>{{ $phieu->getUsers->name }}</span></td>
                                            <td class="tb-col"><span>{{ $phieu->ngay_nhap }}</span></td>
                                            <td class="tb-col tb-col-end"><a href="{{ route('nhap-kho.show', $phieu->ma_phieu_nhap) }}"
        ...
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="scrollableLabel">Nhập thông tin
