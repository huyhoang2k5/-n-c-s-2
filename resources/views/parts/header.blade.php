            ...
            @auth
                ...
                <div class="nk-header-tools">
                    <ul class="nk-quick-nav ms-2">
                        ...
                        @endif
                    @else --}}
                        <li><button class="btn btn-icon btn-sm btn-zoom d-sm-none" data-bs-toggle="offcanvas" data-bs-target="#notificationOffcanvas"><em
                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown">
                                <div class="d-sm-none">
                                    <div class="media media-md media-circle"><img src="{{ asset('storage/images/user/' . auth()->user()->avatar) }}" alt="" class="img-thumbnail"></div>
                                </div>
                                <div class="d-none d-sm-block">
                                    <div class="media media-circle"><img src="{{ asset('storage/images/user/' . auth()->user()->avatar) }}" alt="" class="img-thumbnail"></div>
                                </div>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-md">
                                <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                    <div class="media-group">
                                        <div class="media media-xl media-middle media-circle"><img src="{{ asset('storage/images/user/' . auth()->user()->avatar) }}" alt=""
                                                class="img-thumbnail">
                                        </div>
