                                            ...
                                            <div class="card card-gutter-md">
                                                <div class="card-body">
                                                    <div class="row g-gs">
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="ma_hang_hoa"
                                                                ...
                                                                <div class="form-control-wrap"><input type="text"
                                                                        ...
                                                                        name="ma_hang_hoa" value="{{ old('ma_hang_hoa') }}"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="don_vi_tinh"
                                                                    class="form-label">Đơn vị tính</label>
                                                                <div class="form-control-wrap"><input type="text"
                                                                        class="form-control" id="don_vi_tinh"
                                                                        name="don_vi_tinh" value="{{ old('don_vi_tinh') }}"
                                                                        placeholder="Đơn vị tính"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-gs">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select class="js-select" name="loai_hang_hoa"
                                                                data-search="true" data-sort="false">
                                                                <option value="">Select an option</option>
                                                                @foreach ($loai_hang as $loai)
                                                                    <option value="{{ $loai->id }}"
                                                                        {{ old('loai_hang_hoa') == $loai->id ? 'selected' : '' }}>{{ $loai->ten_loai_hang }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
