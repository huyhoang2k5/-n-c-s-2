                            ...
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    ...
                                    <li style="margin-left: 10px">
                                        <a href="#" class="btn btn-primary d-md-inline-flex" data-bs-toggle="modal" data-bs-target="#xuat_excel">
                                            <em class="icon ni ni-plus"></em>
                                            <span>Export</span>
                                        </a>
                                    </li>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($phieu_xuat as $key => $phieu)
                                        <tr>
                                            ...
                                            <td class="tb-col"><span> {{ Carbon::createFromFormat('Y-m-d', $phieu->ngay_xuat)->format('d-m-Y') }}
                                                </span></td>
